...
function Tabs() {
  return (
    <div style={{
      backgroundImage: `url(${mask1})`, // Add your background image
      backgroundPosition: 'right top', // First image centered, second image top-left
      backgroundSize: '50%', // First image covers, second image half width & full height
      backgroundRepeat: 'no-repeat', // Prevent repeating for both
    }}>
